...
export const ModalRevenda = () => {
    return (
        <ContainerModalHospedagem>
            <ContainerFlex  to={"/revenda-de-hospedagem"}  style={{textDecoration:"none"}}  >
                <Icon>
                    <img src="https://www.squarebrothers.com/images/icon/linux-hosting.svg" alt="" />
                </Icon>
                <Descricao> 
                    <h3>Revenda de hospedagem Linux</h3>
                    <p>
            ...
            <ContainerFlex   to={"/revenda-de-hospedagem"} style={{textDecoration:"none"}}   >
                ...
                <Descricao>
                    ...
                    <h3>Revenda Windows</h3>
                    <p>Comece seu negócio de hospedagem com Plesk hoje</p>
                </Descricao>
            </ContainerFlex>
        </ContainerModalHospedagem>
    )
