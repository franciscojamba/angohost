import { ContainerPlano,Button } from "./card-plano-h-wordpress";
import { FcOk } from "react-icons/fc";

import "./plano-h-wordpress.css"
...
const PlanoHospedagemWordPress=({descricao,features,plano_m,price,title,link_plano}:propsPricingCard)=>{



    return(
        <ContainerPlano className="pricing-card-h-worpress" plano_m={plano_m}  >
...
export default PlanoHospedagemWordPress;
