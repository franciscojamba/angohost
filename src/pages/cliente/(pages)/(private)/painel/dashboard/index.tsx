                    ...
                    <div className="w-full h-[370px] mx-auto flex  items-center border-solid rounded-[30px] pr-[50px] bg-white">
                        ...
                        <div style={{ width: 'calc(100% - 420px' }} className="flex max-w-[500px] items-center justify-center flex-col ml-[50px]">
                            <div>
                                ...
                                <button onClick={()=>router('/contactos')} className="w-full h-[45px] text-white text-[0.9rem] rounded-[8px] mt-3 mb-1.5" style={{ background: 'linear-gradient(122deg, rgba(1,38,83,1) 12%, rgba(0,109,176,1) 100%)' }}>Solicitar orçamento</button>
